...
server = net.addDocker('server', ip='10.0.0.215', dcmd="python app.py", dimage="test_server:latest")
client = net.addDocker('client', ip='10.0.0.216', dimage="test_client:latest")

info('*** Setup network\n')
s1 = net.addSwitch('s12')
s2 = net.addSwitch('s22')
